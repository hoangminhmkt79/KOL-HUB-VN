  ...
  return (
    <>
      ...
      <div style={{ display: 'flex', minHeight: '100vh', background: '#fafafa' }}>
        ...
        {/* ── Sidebar ── */}
        <aside style={{ width: 210, flexShrink: 0, background: '#fff', borderRight: '1px solid #f4f4f5', display: 'flex', flexDirection: 'column', padding: '14px 0' }}>
        ...
        {/* ── Main ── */}
        <main style={{ flex: 1, padding: '20px 24px', minWidth: 0, overflow: 'auto' }}>
